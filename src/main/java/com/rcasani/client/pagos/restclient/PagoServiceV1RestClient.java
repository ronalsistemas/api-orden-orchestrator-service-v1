...
@Component
@AllArgsConstructor
public class PagoServiceV1RestClient {

    private final RestClient pagosV1RestClient;

    public ResponseEntity<Void> consultarSaldo(@RequestBody ConsultarSaldoRequest request) {

        return pagosV1RestClient.post()
                .uri("/consultar-saldo")
                .body(request)
                .retrieve()
                .toBodilessEntity();
    ...
    public ResponseEntity<Void> cargar(@RequestBody CobroRequest request) {
